...
user_input = [
    "Когда среди монстров в лабиринте начали происходить аномальные явления, Отс запросил помощь своих союзников из Империи Ренксандт в поиске и устранении причины проблемы. Приняв запрос, Империя отправила группу рыцарей в лабиринт для расследования."]
output = []
synonyms = {}
